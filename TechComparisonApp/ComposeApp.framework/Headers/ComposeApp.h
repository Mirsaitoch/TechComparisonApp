...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("KMPManager")))
@interface ComposeAppKMPManager : ComposeAppBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@property (class, readonly, getter=companion) ComposeAppKMPManagerCompanion *companion __attribute__((swift_name("companion")));
- (void)addTaskTitle:(NSString *)title description:(NSString *)description onSuccess:(void (^)(ComposeAppTaskModel *))onSuccess onError:(void (^)(NSString *))onError __attribute__((swift_name("addTask(title:description:onSuccess:onError:)")));
- (BOOL)deleteTaskTaskId:(NSString *)taskId __attribute__((swift_name("deleteTask(taskId:)")));
- (void)fetchTasksFromAPIOnSuccess:(void (^)(NSArray<ComposeAppTaskModel *> *))onSuccess onError:(void (^)(NSString *))onError __attribute__((swift_name("fetchTasksFromAPI(onSuccess:onError:)")));
- (NSArray<ComposeAppTaskModel *> *)getCurrentTasks __attribute__((swift_name("getCurrentTasks()")));
- (ComposeAppUser * _Nullable)getCurrentUser __attribute__((swift_name("getCurrentUser()")));
- (NSString *)getKMMInfo __attribute__((swift_name("getKMMInfo()")));
- (BOOL)isValidEmailEmail:(NSString *)email __attribute__((swift_name("isValidEmail(email:)")));
- (BOOL)isValidUsernameUsername:(NSString *)username __attribute__((swift_name("isValidUsername(username:)")));
- (void)loadTasksOnSuccess:(void (^)(NSArray<ComposeAppTaskModel *> *))onSuccess onError:(void (^)(NSString *))onError __attribute__((swift_name("loadTasks(onSuccess:onError:)")));
- (void)loginUsername:(NSString *)username password:(NSString *)password onSuccess:(void (^)(ComposeAppUser *))onSuccess onError:(void (^)(NSString *))onError __attribute__((swift_name("login(username:password:onSuccess:onError:)")));
- (void)logout __attribute__((swift_name("logout()")));
- (BOOL)toggleTaskCompletionTaskId:(NSString *)taskId __attribute__((swift_name("toggleTaskCompletion(taskId:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("KMPManager.Companion")))
@interface ComposeAppKMPManagerCompanion : ComposeAppBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) ComposeAppKMPManagerCompanion *shared __attribute__((swift_name("shared")));
@property (readonly) ComposeAppKMPManager *shared __attribute__((swift_name("shared")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ApiClient")))
@interface ComposeAppApiClient : ComposeAppBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@property (class, readonly, getter=companion) ComposeAppApiClientCompanion *companion __attribute__((swift_name("companion")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)createTaskTask:(ComposeAppTaskModel *)task completionHandler:(void (^)(id _Nullable_result, NSError * _Nullable))completionHandler __attribute__((swift_name("createTask(task:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)fetchTasksWithCompletionHandler:(void (^)(id _Nullable_result, NSError * _Nullable))completionHandler __attribute__((swift_name("fetchTasks(completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)loginUsername:(NSString *)username password:(NSString *)password completionHandler:(void (^)(id _Nullable_result, NSError * _Nullable))completionHandler __attribute__((swift_name("login(username:password:completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ApiClient.Companion")))
@interface ComposeAppApiClientCompanion : ComposeAppBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) ComposeAppApiClientCompanion *shared __attribute__((swift_name("shared")));
@property (readonly) ComposeAppApiClient *instance __attribute__((swift_name("instance")));
@end
...
@interface ComposeAppTaskModel : ComposeAppBase
- (instancetype)initWithId:(NSString *)id title:(NSString *)title description:(NSString *)description isCompleted:(BOOL)isCompleted createdAt:(int64_t)createdAt __attribute__((swift_name("init(id:title:description:isCompleted:createdAt:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) ComposeAppTaskModelCompanion *companion __attribute__((swift_name("companion")));
- (ComposeAppTaskModel *)doCopyId:(NSString *)id title:(NSString *)title description:(NSString *)description isCompleted:(BOOL)isCompleted createdAt:(int64_t)createdAt __attribute__((swift_name("doCopy(id:title:description:isCompleted:createdAt:)")));
...
@interface ComposeAppTaskModelCompanion : ComposeAppBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) ComposeAppTaskModelCompanion *shared __attribute__((swift_name("shared")));
- (NSArray<ComposeAppTaskModel *> *)createSampleTasks __attribute__((swift_name("createSampleTasks()")));
...
- (instancetype)initWithId:(NSString *)id username:(NSString *)username email:(NSString *)email isLoggedIn:(BOOL)isLoggedIn __attribute__((swift_name("init(id:username:email:isLoggedIn:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) ComposeAppUserCompanion *companion __attribute__((swift_name("companion")));
- (ComposeAppUser *)doCopyId:(NSString *)id username:(NSString *)username email:(NSString *)email isLoggedIn:(BOOL)isLoggedIn __attribute__((swift_name("doCopy(id:username:email:isLoggedIn:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@interface ComposeAppUserCompanion : ComposeAppBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) ComposeAppUserCompanion *shared __attribute__((swift_name("shared")));
- (BOOL)isValidEmailEmail:(NSString *)email __attribute__((swift_name("isValidEmail(email:)")));
- (BOOL)isValidUsernameUsername:(NSString *)username __attribute__((swift_name("isValidUsername(username:)")));
- (id<ComposeAppKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
@interface ComposeAppScreen : ComposeAppKotlinEnum<ComposeAppScreen *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly) ComposeAppScreen *login __attribute__((swift_name("login")));
@property (class, readonly) ComposeAppScreen *tasks __attribute__((swift_name("tasks")));
+ (ComposeAppKotlinArray<ComposeAppScreen *> *)values __attribute__((swift_name("values()")));
@property (class, readonly) NSArray<ComposeAppScreen *> *entries __attribute__((swift_name("entries")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MainViewControllerKt")))
@interface ComposeAppMainViewControllerKt : ComposeAppBase
+ (UIViewController *)ComposeViewController __attribute__((swift_name("ComposeViewController()")));
@end
...
@interface ComposeAppPlatformKt : ComposeAppBase
